...
static NSString * const kRetainKeyboardEquivalent = @"com.FlorianPircher.CloseWindow.retainKeyboardEquivalent";

@interface APXCloseWindowPlugin : NSObject<GlyphsPlugin>
@end
